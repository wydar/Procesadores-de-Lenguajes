public class TS{
    ...
    public static void addArray(String var, String type, String tam){
      Node nod = new Node(var,nBlock,type,null,true,Integer.parseInt(tam));
      addNode(nod);
    }

    public static void addMultiArray(String var, String type, String [] dims, int nDim){
      Node nod = new Node(var,nBlock,type,null,true,dims,nDim);
      addNode(nod);
    }

    public static void addNode(Node nod){
